...
>
> **「核桃守卫战」是独立的备选方案 Plan B**，不属于本仓库当前 Demo，也不是「核桃世界」中的关卡或子模块。评审本仓库时，请以 Plan A「核桃世界」为准。
...
- **Plan B — 核桃守卫战：** 另有独立提案，定位为“AI × 飞书内容引擎驱动的可编程塔防学习系统”；仅在需要切换整体方案时使用，不与本仓库的演示流程混合。
